...
file(GLOB MDK_DAV1D "${MDK_RUNTIME_DIR}/*dav1d*.*")
...
mark_as_advanced(MDK_INCLUDE_DIRS MDK_ABI_INCLUDE_DIRS MDK_LIBRARIES MDK_FFMPEG MDK_LIBASS MDK_DAV1D MDK_RUNTIME_DIR MDK_PLUGINS)
...
if(MDK_RUNTIME)
  ...
  if(MDK_DAV1D)
    list(APPEND MDK_RUNTIMES ${MDK_DAV1D})
  endif()
  if(MDK_PLUGINS)
...
if(APPLE)
  ...
  if(ANDROID OR OHOS)
    ...
    #target_link_libraries(mdk INTERFACE GLESv3) # required by dlsym(NULL, glSymb). EGL?
  ...
  if(OHOS)
    if(EXISTS "${MDK_DAV1D}")
      add_library(mdk-dav1d SHARED IMPORTED)
      set_target_properties(mdk-dav1d PROPERTIES
              IMPORTED_LOCATION "${MDK_DAV1D}")
      target_link_libraries(mdk INTERFACE mdk-dav1d)
    endif()
  endif()
endif()
