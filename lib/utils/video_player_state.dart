...
int _exactEndStreak = 0;
  ...
  final String _subtitleColorKey = 'subtitle_color';
    ...
    // 内嵌字幕（内核轨/sub-color）独立颜色——与外挂叠层(subtitleColor)分离，
    // 改外挂不影响内嵌，反之亦然
    final String _subtitleEmbeddedColorKey = 'subtitle_embedded_color';
  ...
  int _subtitleColorValue = defaultSubtitleColorValue;
    ...
    int _subtitleEmbeddedColorValue = defaultSubtitleColorValue;
  ...
  Color get subtitleColor => Color(_subtitleColorValue);
    ...
    Color get subtitleEmbeddedColor => Color(_subtitleEmbeddedColorValue);
