...
// test/anime_info/refresh_bangumi_anime_cache_json_test.dart
...
void main() {
  ...
  test('刷新 Bangumi Anime Info 到 JSON 缓存', () async {
    ...
    await AnimeInfoService.refreshBangumiAnimeCacheJson(bangumiAnimeId);
  });
}
